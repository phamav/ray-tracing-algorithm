...
//IDisk* disk = new IDisk(dvec3(0.0, 5.0, 0.0), dvec3(0, 0, 1), 3.0);
//IClosedConeY* closedCone = new IClosedConeY(dvec3(3.0, 5.0, 0.0), 2.0, 1.0);
//ICylinderY* cylinderY = new ICylinderY(dvec3(6.0, 5.0, 0.0), 2.0, 1.0);
//
//void buildScene() {
...
//    scene.addOpaqueObject(new VisibleIShape(sphere2, yellowRubber));
//    scene.addOpaqueObject(new VisibleIShape(disk, ruby));
//    scene.addOpaqueObject(new VisibleIShape(closedCone, cyanRubber));
